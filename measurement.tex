...
\begin{remark}
  ...
  To same some thing has a quantity of x just means that it is located
  at a certain point in an algebraic structure.  Maybe this isn't
  deflation, but it is something.
\end{remark}
